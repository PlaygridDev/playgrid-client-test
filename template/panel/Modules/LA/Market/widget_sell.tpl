...
{$.site._SEO->addTegHTML('footer', 'wizard_sell', 'script', ['src'=> $.const.VIEWPATH~'/panel/Modules/LA/Market/widget_sell.js?ver=0.52'])}
...
<div class="js-wizard-simple block">
    ...
    <form action="/input"  method="post" onsubmit="return false;">
        {$.php.form_hide_input("Modules\LA\Market\Market", "ajax_sell_item")}
