{$.php.form_hide_input("Modules\LA\Market\Market", "ajax_buy_shop")}
            ...
            {if $item.type == "3"}
                <tr>
                    ...
                    <td class="text-left" style="width: 50%;">
                        ...
                        {/foreach}
                        <br>
                        <button type="submit" class="btn btn-sm btn-outline-primary submit-btn mt-1" {$.php.btn_ajax("Modules\LA\Market\Market", "ajax_show_inventory", ['id' => $item.shop_id])}>{$ajax_buy_shop_all_inventory}</button>
                    </td>
                </tr>
            {/if}
        </table>
