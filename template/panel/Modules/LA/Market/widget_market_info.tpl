            ...
            <div class="row">
                ...
                <div class="col-3 col-md-3 text-center ">
                    <h5 class="pb-0">
                        ...
                        <small>
                            <br><a href="javascript:void();" title="{$widget_user_refresh}" class="submit-btn font-size-sm" {$.php.btn_ajax("Modules\LA\Market\Market", "ajax_refresh_info_two")}>Обновить</a>
                        </small>
                    </h5>
