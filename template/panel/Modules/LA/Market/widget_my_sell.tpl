            ...
            <table class="table table-striped table-vcenter">
                ...
                {foreach $data as $item}
                    <tr>
                        ...
                        <td class="text-right">
                            <button type="submit" class="btn btn-sm btn-outline-primary submit-btn" {$.php.btn_ajax("Modules\LA\Market\Market", "ajax_stop_selling", ['id' => $item.id])}>{$widget_my_sell_remove}</button>
                        </td>
                    </tr>
                {/foreach}
                </tbody>
