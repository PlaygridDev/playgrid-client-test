        ...
        <div class="row no-gutters">
            ...
            <div class="col-12 col-md-5 text-center">
                ...
                <p class="mt-10">
                    ...
                    <a href="javascript:void();" title="{$widget_user_refresh}" class="submit-btn" {$.php.btn_ajax("Modules\LA\Market\Market", "ajax_refresh_info")}><i class="si si-refresh fa-2x"></i></a>
                </p>
