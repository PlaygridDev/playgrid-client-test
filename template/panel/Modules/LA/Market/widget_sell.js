...
$('.check_char_market').on('click', function(){
    ...
    if($('#inventory_'+id).length){
        ...
        $('#inventory_list').append('<div id="inventory_'+id+'" class="inv-div text-center"><button type="button" class="btn btn-outline-primary submit-btn" data-post="module_form=Modules%5CLA%5CMarket%5CMarket&module=ajax_loud_inventory&char_id='+id+'&char_name='+name+'&account_name='+account+'&type=select" data-action="/input">' +
...
$('.check_char_sell_market').on('click', function(){
    ...
    if($('#inventory_'+id).length){
        ...
        $('#inventory_list').append('<div id="inventory_'+id+'" class="inv-div text-center"><button type="button" class="btn btn-outline-primary submit-btn" data-post="module_form=Modules%5CLA%5CMarket%5CMarket&module=ajax_loud_inventory&char_id='+id+'&char_name='+name+'&account_name='+account+'&type=not_select" data-action="/input">' +
            '<i class="si si-cloud-download mr-5"></i>Загрузить инвентарь</button>' +
            '</div>');
    }
