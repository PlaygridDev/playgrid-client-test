{$.site._SEO->addTegHTML('head', 'market_style', 'link', ['rel' => "stylesheet", "href" => $.const.VIEWPATH~'/panel/Modules/LA/Market/market_style.css?6'])}
                                ...
                                <tr>
                                    ...
                                    {if $category == "character"}
                                        <td>
                                            ...
                                            {/foreach}
                                            <button type="submit" class="btn btn-sm btn-outline-primary submit-btn ml-1" {$.php.btn_ajax("Modules\LA\Market\Market", "ajax_show_inventory", ['id' => $item.shop_id])}>{$all_inventory}</button>
                                        </td>
                                    {/if}
                                    {if $category != "coin" && $category != "character"}
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-primary submit-btn" {$.php.btn_ajax("Modules\LA\Market\Market", "ajax_buy_shop_popup", ['id' => $item.id])}>{$buy}</button>
                                        </div>
                                    </td>
                                </tr>
                            {/foreach}
